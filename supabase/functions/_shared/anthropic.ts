...
// and a request timeout. Used by all Leuro edge functions that talk to
// Claude (generate-study-guide, generate-mock-exam, grade-mock-exam).
...
export async function callClaude(systemPrompt: string, userPrompt: string, maxTokens: number): Promise<ClaudeResult> {
