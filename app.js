    ...
    <div class="modal-overlay" data-action="close-tc-modal">
      <div class="modal-sheet" onclick="if (!event.target.closest('[data-action]')) event.stopPropagation()">
        ...
        <div class="modal-body legal-modal-body">
          ...
          <p>Leuro™ is an AI-assisted educational tool designed to support South African learners (Grades 4–12) with original AI-generated study content, diagnostic assessments, and mock examinations aligned to the South African national curriculum (CAPS).</p>
