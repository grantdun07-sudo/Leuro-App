    ...
    <div class="modal-overlay" data-action="close-tc-modal">
      <div class="modal-sheet" onclick="event.stopPropagation()">
        ...
        <div class="modal-body legal-modal-body">
          ...
          <p>Leuro™ is an AI-assisted educational tool designed to support South African learners (Grades 4–12) with curriculum-aligned study content, diagnostic assessments, and mock examinations based on the CAPS and IEB curricula.</p>
          ...
          <ul>
            ...
            <li>Mock examination questions and answer keys are generated by AI and have not been verified by a qualified educator unless explicitly stated.</li>
            <li>Leuro™ content is intended as a study aid only and does not replace your teacher, textbooks, or official DBE/IEB materials.</li>
        ...
        <div class="modal-body legal-modal-body">
          ...
          <table class="legal-table">
            ...
            <tbody>
              ...
              <tr><td>Grade and school curriculum (CAPS/IEB)</td><td>Personalising content</td></tr>
